...
function BackgroundFX() {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
      <div className="absolute -left-[10%] top-[-20%] size-[60svh] rounded-full bg-violet-500/30 blur-[120px] animate-blob" />
      <div className="absolute right-[-10%] bottom-[-15%] size-[50svh] rounded-full bg-fuchsia-500/25 blur-[140px] animate-blob-slow" />
    </div>
  )
}
